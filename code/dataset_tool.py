...
#     temp = PIL.Image.open(image_filenames[0]) #changes channel to proper value

#     # replace alpha channel with white color
#     im = PIL.Image.new('RGB', temp.size, (255, 255, 255))
#     im.paste(temp, None)
...
#             temp2 = PIL.Image.open(image_filenames[order[idx]])
# #             print(temp2)
#             # replace alpha channel with white color
#             im2 = PIL.Image.new('RGB', temp2.size, (255, 255, 255))
#             im2.paste(temp2, None)
